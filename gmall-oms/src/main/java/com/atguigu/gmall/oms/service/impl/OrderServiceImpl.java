...
public class OrderServiceImpl extends ServiceImpl<OrderDao, OrderEntity> implements OrderService {
    ...
    public OrderEntity saveOrder(OrderSubmitVO submitVO) {
        ...
        Resp<MemberEntity> memberEntityResp = this.umsClient.queryMemberByUserId(submitVO.getUserId());
        ...
        items.forEach(item -> {
            ...
            Resp<SkuInfoEntity> skuInfoEntityResp = this.pmsClient.querySkuInfoBySkuId(item.getSkuId());
            SkuInfoEntity skuInfoEntity = skuInfoEntityResp.getData();

            Resp<SpuInfoEntity> spuInfoEntityResp = this.pmsClient.querySpuInfoBySpuId(skuInfoEntity.getSpuId());
